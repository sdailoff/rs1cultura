    ...
    <div class="col-md-4 mb-3" style="margin:auto;">
        ...
        <div class="container" align="center">
            <form class="form-signin" method="POST" action="Perfil.php">
                ...
                <h1 class="titlePage mt-5 mb-5">Mi Perfil</h1>

                <label for="usuario"  style="color: black;">Usuario</label>
                <input type="text" id="usuario" name="usuario" class="form-control" placeholder="Usuario" required style="text-align: center"
                       value="<?=strtoupper($usuario_actual)?>" readonly>
                <br>
                <label for="contrasena" class="">Contraseña</label>
                <input type="password" id="contrasena" name="contrasena" class="form-control" placeholder="Contraseña" style="text-align: center"
                       required>
                <br><br>
                <button class="btn btn-lg btn-primary btn-block mb-5" type="submit">Cambiar contraseña</button>
            </form>
        </div>
